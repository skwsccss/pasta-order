            ...
            <div className="bowlSelectContainer updatet forSumm">
                ...
                <div className="under-sect plpops">
                {
                  this.renderbtn()
                    ...
                    {
                        this.props.data.meatTypes.map((item , index) => {
                           return  <Plcomponent type={'meet'} info = {item} key= {index} id={index}/>
                        })
                    }
                </div>
                <Link className="skpBtn">Skip >></Link>
                <Link to="/selectsides" className="nextBtn wtCart">Next</Link>
